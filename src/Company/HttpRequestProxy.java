...
public class HttpRequestProxy {
	...
	/**
	 * @return 连接超时(毫秒)
	 * @see Company.hengpeng.common.web.HttpRequestProxy#connectTimeOut
	 */
	...
	/**
	 * @return 读取数据超时(毫秒)
	 * @see Company.hengpeng.common.web.HttpRequestProxy#readTimeOut
	 */
	...
	/**
	 * @return 请求编码
	 * @see Company.hengpeng.common.web.HttpRequestProxy#requestEncoding
	 */
